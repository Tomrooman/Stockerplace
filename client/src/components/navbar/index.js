...
class NavbarComponent extends Component {
  ...
  render() {
    if (this.props.url !== undefined) {
      ...
      return (
        <nav className="navbar navbar-expand-lg stocker-nav">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            {this.props.user ?
              ...
              <div>
                <button className="btn btn-outline-info my-2 my-sm-0" onClick={this.props.connect_modal}>Se connecter</button>
                <button className="btn btn-outline-success my-2 my-sm-0" onClick={this.props.subscribe_modal}>S'inscrire</button>
              </div>
            }
          </div>
        </nav>
