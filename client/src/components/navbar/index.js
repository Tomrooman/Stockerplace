    ...
    if (this.props.url !== undefined) {
      ...
      return (
        <nav className="navbar navbar-expand navbar-fixed-top navbar-light stocker-nav">
          <a className="navbar-brand stocker-nav-title" href="/">
            Stockerplace
          </a>
          <button
          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            >
              <a
                className="nav-link dropdown-toggle stocker-nav-sub"
                href="/"
              ...
              >
                ...
                <a className="dropdown-item" href="/cloud/upload">
                  Uploader
                </a>
              </div>
            </li>
            <li
              className={current === "social" ? "nav-item active" : "nav-item"}
            >
              <a className="nav-link stocker-nav-sub" href="/social">
                Social
              </a>
            </li>
          </ul>
